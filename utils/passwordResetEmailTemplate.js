                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td>
                                                                            ...
                                                                            <p style="font-size:16px">Forgot your password?</p>
                                                                            <p style="font-size:16px">
                                                                                Click the button below to reset your password. This link is specific to you and valid for 10 minutes.
                                                                            </p>
                                                                            <p style="font-size:16px">
                                                                                If you didn't forget your email, please ignore this mail.
                                                                            </p>
                                                                        </td>
                                                                    </tr>
                                                                    ...
                                                                    <tr style="height:44px;width:490px">
                                                                        <td style="background-color:#007dc6;color:#ffffff;font-size:16px;height:49px;text-align:center">
                                                                            <div>
                                                                                <a href=${options.passwordResetLink} style="background-color:#007dc6;color:#ffffff;display:inline-block;font-size:16px;font-weight:bold;text-align:center;text-decoration:none;width:490px" target="_blank">Reset Password</a>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
